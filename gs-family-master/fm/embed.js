(function () {
  ...
  function initEmbed() {
    ...
    var btns = document.querySelectorAll('.lp4663918080557056');
    var bgColor = jQuery('.lp4663918080557056').css('background-color')
    ...
    for (var i = 0; i < btns.length; i++) {
      btns[i].addEventListener("click", function (e) {
        handler.open({
          ...
          email: urlEmail,
          description: validCoupon ? couponDesc : "$9 / monthly",
    ...
    jQuery('.couponLink').click(function (evt) {
      jQuery(evt.target).replaceWith(
        `<form style=`+ formStyle +`  class="couponForm lp4663918080557056">
          <input
            style=` + inputStyle + `
            type="text" 
      ...
      jQuery('.couponForm.lp4663918080557056').submit(function (e) {
        e.preventDefault()
